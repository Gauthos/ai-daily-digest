...
xychart-beta horizontal
    title "高频关键词"
    x-axis ["ai agents", "developer tools", "adoption", "bias", "windows", "waitformultipleobjects", "handles", "concurrency", "package registry", "pagination", "metadata", "scalability"]
    y-axis "出现次数" 0 --> 3
...
**ai agents**(1) · **developer tools**(1) · **adoption**(1) · bias(1) · windows(1) · waitformultipleobjects(1) · handles(1) · concurrency(1) · package registry(1) · pagination(1) · metadata(1) · scalability(1) · rss(1) · atom(1) · feeds(1) · privacy(1) · productivity(1) · burnout(1) · work culture(1) · career(1)
